...
\begin{figure}[H]
    \center
	\includegraphics[width=13cm]{Images/newpostbutton001.png}
...
\begin{figure}[H]
    \center
	\includegraphics[width=13cm]{Images/article001.png}
